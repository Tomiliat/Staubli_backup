  ...
  */
  ...
  while (node.ok()){
    ...
    try{
      ...
      */
      // (note for the future) Problems with coordinates? Change "base_link" and "tool0" order. Remember to correct value by multiplicating or dividing, currently tf is showing X-100 as X-0.100...?
